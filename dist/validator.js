...
for(e=0,a=cardTypes.length;a>e;e++){if(cardTypes[e].hasOwnProperty("pattern")&&t.match(cardTypes[e].pattern))return cardTypes[e]
...
for(r=0,h=t.split("").reverse(),a=n=0,i=h.length;i>n;a=++n)e=h[a],e=+e,a%2?(e*=2,r+=10>e?e:e-9):r+=e
